      ...
      <el-main>
        ...
        >
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="最高水平" prop="coutry">
              <el-input v-model="ruleForm.country"></el-input>
            </el-form-item>
            <el-form-item label="平均分" prop="score" :default-sort="{ prop: 'score',order: 'descending'}">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          country: [
            {required: true, message: '请输入最高的国际化水平名称', trigger: 'blur'},
          ],
          score: [
            {required: true, message: '请输入国际化平均分', trigger: 'blur'},
          ],
        },
        pageNumber: 1,
        pageSize: 5,
